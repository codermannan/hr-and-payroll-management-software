...
class Barcode extends CI_Controller
{
    ...
    public function index()
    {
        ...
        {
            $parsingData['employeeData'] = $this->Search_Model->employeeDataForBarcode();
            $parsingData['username'] = $this->session->userdata('username');
            $this->load->view('pages/barcode', $parsingData);
        }
    }
...
//        $this->uri->segment(6);
        ...
        //if(isset($this->input->post('quality'))) $quality = $this->input->post('quality');
        $width = $this->uri->segment(4);
        $height = $this->uri->segment(5);
        //if(isset($this->input->post('type'))) $type = $this->input->post('type');
        //if(isset($this->input->post('barcode'))) $barcode = $this->input->post('barcode');
