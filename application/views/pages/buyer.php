...
var hn = '<?php echo base_url();?>buyer/searchData';
$('document').ready(function(){

	$(".preload").fadeOut(6000, function() {
        $(".searchBuyer").fadeIn(1000);        
    });
    $('input#searchBuyer').keyup( function() {
        var msg = $('#searchBuyer').val();
            ...
            <div class="row">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Type Buyer Code or Name" name="searchBuyer" id="searchBuyer" />
                            </div>
                            <br />
                ...
                <div class="col-lg-4">
                    <div class="panel panel-primary">
                        ...
                        <?php
                            $attributes = array('name' => 'form-buyer', 'id' => 'form-buyer', 'class' => 'form-buyer');
                            if(isset($buyer_id))
                            {
                                echo form_open("buyer/edit", $attributes);
                            }
                            else
                            {
                                echo form_open("buyer/submitData", $attributes);
                            }
                        ?>
                        <div class="panel-body">
                            <table id="entry-panel">
                                <tr>
                                    <td>Buyer Code</td>
                                    <td><input type="text" class="form-control" placeholder="Buyer Code" name="buyerCode" id="buyerCode" required readonly value="<?php if(isset($buyer_id)) echo $buyer_id; else echo $nextId;?>" /></td>
                                </tr>
                                <tr>
                                    <td>Buyer Name</td>
                                    <td><input type="text" placeholder="Type Buyer Name" name="buyerName" id="buyerName" value="<?php if(isset($buyer_name)) echo $buyer_name;?>" required /></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
