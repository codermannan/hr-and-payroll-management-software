...
function loadBlockMajor()
{
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>overtime_bonus/loadBlockMajor/",
...
function insertData(employeeId)
{
    ...
    var qurl = '<?php echo base_url();?>overtime_bonus/submitData';
    //alert(dateId);
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h5>Employee Overtime Entry Panel</h5> 
                        </div>
                        ...
                        <?php
                            ...
                            echo form_open("overtime_bonus/searchEmployee", $attributes);
                        ?>
                        ...
                        <?php
                            ...
                            echo form_open("overtime_bonus/submitData", $attributes);
                        ?>
                            ...
                            <table id="searchTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center; width: 80px;">Overtime Days</th>
                                        <th style="text-align: center; width: 80px;">Overtime Hours</th>
                                        <th style="text-align: center; width: 100px;">Total Ammount</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                        <?php $loopCount = 1; if(isset($employeeDataOvertimeBonus)){ foreach ($employeeDataOvertimeBonus as $key => $row):?>
                                        <tr>
                                            <td><?php echo $row['employee_pre_code']."-".$row['employee_code'];?></td>
                                            <td><?php echo $row['employee_name'];?></td>
                                            <td><?php echo $row['designation_name'];?></td>
                                            <td style="text-align: center;">
                                            <input type="text" name="overtimeDays_<?php echo $loopCount;?>" id="overtimeDays_<?php echo $loopCount;?>" style="width:80px;" value="<?php if(isset($month)){if($month == 1) echo 31;elseif($month == 2) echo 28;elseif($month == 3) echo 31;elseif($month == 4) echo 30;elseif($month == 5) echo 31;elseif($month == 6) echo 30;elseif($month == 7) echo 31;elseif($month == 8) echo 31;elseif($month == 9) echo 30;elseif($month == 10) echo 31;elseif($month == 11) echo 31;elseif($month == 12) echo 30;};?>" />
                                            </td>
                                            <td style="text-align: center;">
                                            <input type="text" name="overtimeHours_<?php echo $loopCount;?>" id="overtimeHours_<?php echo $loopCount;?>" style="width:80px;" value="0" />
                                            </td>
                                            <td style="text-align: center;">
                                                <?php 
                                                    $sum = 250;
                                                ...
                                                ?>
                                                <input type="text" name="calculateSalary_<?php echo $loopCount;?>" id="calculateSalary_<?php echo $loopCount;?>" style="width:80px;" value="<?php echo $sum;?>" /> BDT
                                            </td>
                                        </tr>
