                        ...
                        <div class="panel-body">
                            <table id="entry-panel">
                                ...
                                <tr>
                                    ...
                                    <td>Or</td>
                                    <td><h5><a href="<?php echo base_url();?>salary_sheet_view/searchCurrent" style="font-weight:bold; color: #00ee00;">Current Month</a></h5></td>
                                </tr>
                            </table>
                            ...
                            <table id="searchTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: left; width: 90px;">Gross Salary</th>
                                        <th style="text-align: left; width: 90px;">Production Bonus</th>
                                        <th style="text-align: left; width: 90px;">Attendance Bonus</th>
                                        <th style="text-align: left; width: 90px;">Overtime Bonus</th>
                                        <th style="text-align: left; width: 90px;">Total Salary</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                        <?php 
                                            ...
                                            { 
                                               // var_dump($salaryData);
                                                foreach ($salaryData as $key => $row):
                                        ?>
                                        <tr>
                                            <td><?php echo $row['employee_pre_code']."-".$row['employee_code'];?></td>
                                            <td><?php echo $row['employee_name'];?></td>
                                            <td><?php echo $row['designation_name'];?></td>
                                            <td><?php echo $row['salary_sheet_amount'];?></td>
                                            <td><?php echo $row['production_bonus_amount'];?></td>
                                            <td style="text-align: right;"><?php echo $row['attendance_bonus_amount'];?></td> 
                                            <td style="text-align: right;"><?php echo $row['overtime_bonus_amount'];?></td> 
                                            <td><?php $totalSalary = $row['salary_sheet_amount']+$row['production_bonus_amount']+$row['attendance_bonus_amount']+$row['overtime_bonus_amount']; echo $totalSalary;?></td>
                                        </tr>
                                        <?php endforeach;}?>
                                 </tbody>    
                            </table>
